...
clear
getmata (var*)=table
export excel using "$TABLES\main_analysis_PSM_ATET.xlsx", cell (A1) sheet(Income, replace) 
restore


* 3.1.2 Income 2
*................
//*These outcome variables are defined in the HH with positive income in each category, and therefore zero-values are considering as missing 
...
*Control variables 
//*Note: I exclude province FE due to the small sample size of these outcome variables
...
clear
getmata (var*)=table
export excel using "$TABLES\main_analysis_PSM_ATET.xlsx", cell (A1) sheet(Income2, replace) 
restore
...
clear
getmata (var*)=table
export excel using "$TABLES\main_analysis_PSM_ATET.xlsx", cell  (A1) sheet(Activos, replace) 
restore	
...
clear
getmata (var*)=table
export excel using "$TABLES\main_analysis_PSM_ATET.xlsx", cell (A1) sheet(Fuente, replace) 
restore
...
clear
getmata (var*)=table
export excel using "$TABLES\main_analysis_PSM_ATET.xlsx", cell (A1) sheet(Fuente_perc, replace) 
restore
...
clear
getmata (var*)=table
export excel using "$TABLES\main_analysis_PSM_ATET.xlsx", cell (A1) sheet(Prod, replace) 
restore
...
clear
getmata (var*)=table
export excel using "$TABLES\main_analysis_PSM_ATET.xlsx", cell  (A1) sheet(Ventas, replace) 
restore	
...
clear
getmata (var*)=table
export excel using "$TABLES\main_analysis_PSM_ATET.xlsx", cell (A1) sheet(Ventas_sh, replace) 
restore
...
clear
getmata (var*)=table
export excel using "$TABLES\main_analysis_PSM_ATET.xlsx", cell (A1) sheet(Resiliencia, replace) 
restore
...
clear
getmata (var*)=table
export excel using "$TABLES\main_analysis_PSM_ATET.xlsx", cell (A1) sheet(Resiliencia2, replace) 
restore
...
clear
getmata (var*)=table
export excel using "$TABLES\main_analysis_PSM_ATET.xlsx", cell (A1) sheet(Alimentos, replace) 
restore
...
clear
getmata (var*)=table
export excel using "$TABLES\main_analysis_PSM_ATET.xlsx", cell (A1) sheet(Alimentos2, replace) 
restore
...
clear
getmata (var*)=table
export excel using "$TABLES\main_analysis_PSM_ATET.xlsx", cell (A1) sheet(Women, replace) 
restore
...
clear
getmata (var*)=table
export excel using "$TABLES\main_analysis_PSM_ATET.xlsx", cell (A1) sheet(Otros, replace) 
restore
...
gl matching		region hhsize fem_head agehead ed_hhh disab /// //demographics
				tot_tlu_bl dindex_pca_bl pindex_pca_bl housingindex_mca_bl /// //Asset
				lravg_totrain cov_totrain lravg_avgtemp_mean lravg_avgtemp_min lravg_avgtemp_max cov_avgtemp_mean cov_avgtemp_min cov_avgtemp_max lravg_evi lravg_ndvi /// // GIS
				pop_density_2020 altitude  // Geographic variables
...
global dep_vars gross_margin_CAFE gross_margin_CACAO  gross_margin_PALTA gross_margin_QUINUA  crop_val_CAFE crop_val_CACAO  crop_val_PALTA  crop_val_QUINUA  yields_CAFE yields_CACAO  yields_PALTA yields_QUINUA  cuy_val_liv dairy_val_liv  
...
*Control Variables
gl outcomeeq	agehead ed_hhh  prod_tot dis_main_road t_main_town output_market_15k  lravg_evi lindex_pca_bl member_status hh_sample 
...
clear
getmata (var*)=table
export excel using "$TABLES\main_analysis_PSM_ATET.xlsx", cell (A1) sheet(Prod2, replace) 
restore
...
clear
getmata (var*)=table
export excel using "$TABLES\main_analysis_PSM_ATET.xlsx", cell (A1) sheet(Prod3, replace) 
restore

*10.2 Participacion en el mercado
*..................................

global dep_vars dmktac_crop_CACAO dmktac_crop_CAFE dmktac_crop_PALTA dmktac_crop_QUINUA dmktac_liv_cuy dmktac_liv_dairy 
...
clear
getmata (var*)=table
export excel using "$TABLES\main_analysis_PSM_ATET.xlsx", cell (A1) sheet(Mercados, replace) 
restore
...
clear
getmata (var*)=table
export excel using "$TABLES\main_analysis_PSM_ATET.xlsx", cell (A1) sheet(Mercados2, replace) 
restore

*10.3 Valor de ventas
*.....................

global dep_vars v_ag_sales_CACAO v_ag_sales_CAFE v_ag_sales_PALTA v_ag_sales_QUINUA v_liv_sales_cuy v_liv_sales_dairy v_liv_sales
...
clear
getmata (var*)=table
export excel using "$TABLES\main_analysis_PSM_ATET.xlsx", cell  (A1) sheet(Ventas2, replace) 
restore	 
...
clear
getmata (var*)=table
export excel using "$TABLES\main_analysis_PSM_ATET.xlsx", cell  (A1) sheet(Ventas3, replace) 
restore	 


*10.4 Participacion en el mercado (%)
*....................................

global dep_vars prop_ag_sales_CACAO prop_ag_sales_CAFE prop_ag_sales_PALTA prop_ag_sales_QUINUA prop_liv_sales prop_liv_sales_cuy prop_liv_sales_dairy
...
clear
getmata (var*)=table
export excel using "$TABLES\main_analysis_PSM_ATET.xlsx", cell (A1) sheet(Ventas_sh2, replace) 
restore
...
clear
getmata (var*)=table
export excel using "$TABLES\main_analysis_PSM_ATET.xlsx", cell (A1) sheet(Ventas_sh3, replace) 
restore
