...
clear
getmata (var*)=table
export excel using "$TABLES\PSMATCH_ATET.xlsx", cell (A1) sheet(Income, replace) 
restore
...
clear
getmata (var*)=table
export excel using "$TABLES\PSMATCH_ATET.xlsx", cell (A1) sheet(Income2, replace) 
restore
...
clear
getmata (var*)=table
export excel using "$TABLES\PSMATCH_ATET.xlsx", cell  (A1) sheet(Activos, replace) 
restore	
...
clear
getmata (var*)=table
export excel using "$TABLES\PSMATCH_ATET.xlsx", cell (A1) sheet(Fuente, replace) 
restore
...
clear
getmata (var*)=table
export excel using "$TABLES\PSMATCH_ATET.xlsx", cell (A1) sheet(Fuente_perc, replace) 
restore
...
clear
getmata (var*)=table
export excel using "$TABLES\PSMATCH_ATET.xlsx", cell (A1) sheet(Prod, replace) 
restore
...
clear
getmata (var*)=table
export excel using "$TABLES\PSMATCH_ATET.xlsx", cell (A1) sheet(Ventas, replace) 
restore	
...
clear
getmata (var*)=table
export excel using "$TABLES\PSMATCH_ATET.xlsx", cell (A1) sheet(Ventas_sh, replace) 
restore
...
clear
getmata (var*)=table
export excel using "$TABLES\PSMATCH_ATET.xlsx", cell (A1) sheet(Resiliencia, replace) 
restore
...
clear
getmata (var*)=table
export excel using "$TABLES\PSMATCH_ATET.xlsx", cell (A1) sheet(Resiliencia2, replace) 
restore
...
clear
getmata (var*)=table
export excel using "$TABLES\PSMATCH_ATET.xlsx", cell (A1) sheet(Alimentos, replace) 
restore
...
clear
getmata (var*)=table
export excel using "$TABLES\PSMATCH_ATET.xlsx", cell (A1) sheet(Alimentos2, replace) 
restore
...
clear
getmata (var*)=table
export excel using "$TABLES\PSMATCH_ATET.xlsx", cell (A1) sheet(Women, replace) 
restore
...
clear
getmata (var*)=table
export excel using "$TABLES\PSMATCH_ATET.xlsx", cell (A1) sheet(Otros, replace) 
restore
...
clear
getmata (var*)=table
export excel using "$TABLES\PSMATCH_ATET.xlsx", cell (A1) sheet(Prod2, replace) 
restore
				
*10.2 Acceso al Mercado 
*.......................
...
clear
getmata (var*)=table
export excel using "$TABLES\PSMATCH_ATET.xlsx", cell (A1) sheet(Mercados, replace) 
restore
...
clear
getmata (var*)=table
export excel using "$TABLES\PSMATCH_ATET.xlsx", cell  (A1) sheet(Ventas2, replace) 
restore	
...
clear
getmata (var*)=table
export excel using "$TABLES\PSMATCH_ATET.xlsx", cell (A1) sheet(Ventas_sh2, replace) 
restore
